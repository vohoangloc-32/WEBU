  ...
  return (
    <div className="w-full flex flex-col border border-tonal-a30 rounded-lg overflow-hidden mt-4">
      ...
      <div className="grid grid-cols-4 bg-tonal-a20 border-b border-tonal-a30">
        ...
        <div className="py-4 text-center text-white h6">Tag</div>
        <div className="py-4 text-center text-white h6">Group</div>
          ...
          >
            ...
            <div className="flex justify-center flex-wrap gap-2 px-2">
              {item.tags.map((tag) => (
                <span
                  key={tag}
                  className="bg-secondary-a50 text-tonal-a0 px-4 py-1 rounded-[100px] p8 font-bold"
                >
                  {tag}
                </span>
              ))}
            ...
            <div className="flex justify-center">
              <span className="bg-tonal-a30 text-white px-6 py-2 rounded-[100px] p8 font-bold">
                {item.group}
              </span>
            </div>
            ...
            <div className="flex justify-center">
              <span
                className={`px-6 py-1 rounded-[100px] p8 font-bold ${getDifficultyColor(item.difficulty)}`}
              >
                {item.difficulty}
              </span>
            </div>
